...
Public Function vectToVector(v As vect) As vector
    vectToVector.pos(0) = v.x
    vectToVector.pos(1) = v.y
    vectToVector.pos(2) = v.z
    vectToVector.pos(3) = 1
End Function

Public Function arrayToVector(a() As Long) As vector
    arrayToVector.pos(0) = CSng(a(0))
    arrayToVector.pos(1) = CSng(a(1))
    arrayToVector.pos(2) = CSng(a(2))
    arrayToVector.pos(3) = 1
End Function
...
Public Sub vect_transform3(v As vector, m As matrix)
...
Public Sub vect_add(vect As vector, vect2 As vector)
...
Public Function vect_substract(vect1 As vector, vect2 As vector) As vector
    vect_substract.pos(0) = vect1.pos(0) - vect2.pos(0)
    vect_substract.pos(1) = vect1.pos(1) - vect2.pos(1)
    vect_substract.pos(2) = vect1.pos(2) - vect2.pos(2)
    vect_substract.pos(3) = vect1.pos(3) - vect2.pos(3)
End Function

Public Function vect_getDistance(v1 As vector, v2 As vector) As Single
    Dim vSub As vector
    Dim dXY As Single
    Dim dYZ As Single
    
    vSub = vect_substract(v1, v2)
    
    dXY = Sqr(vSub.pos(0) * vSub.pos(0) + vSub.pos(1) * vSub.pos(1))
    dYZ = Sqr(vSub.pos(1) * vSub.pos(1) + vSub.pos(2) * vSub.pos(2))
    vect_getDistance = Sqr(dXY * dXY + dYZ * dYZ)
End Function
